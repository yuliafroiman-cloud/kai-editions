...
1. ~~**נדירות**~~ ✅ **נסגר:** 3 טיפוסים — **Regular / Silver / Gold**. ההדמיות הישנות (`boxes/`) עם 4 טיפוסים — לא רלוונטיות. ראו [../../docs/page-blocks.md](../../docs/page-blocks.md).
...
4. **מספור קלפים** — המספר (`xx/NN`) דינמי לפי גודל הקולקציה: 24 / 48 / 72. ההדמיות מראות `/48` (גודל אמצע). הדמיות עם `/50` — להתעלם.
