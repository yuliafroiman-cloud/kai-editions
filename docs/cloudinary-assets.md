...
### Packages — "בחרו את הקולקציה שמתאימה לסיפור שלכם" (מודול M8)
| public_id | מה | סטטוס |
|---|---|---|
| `kai-editions/packages/box-24` | שוט מוצר לחבילת "הרגעים שלנו" (קופסה + אלבום + הדפסים + עט + ברכה) | 🟡 זמני — חתוך מההדמיה (07/09) |
| `kai-editions/packages/box-48` | שוט מוצר לחבילת "הסיפור שלנו" (קופסה + חפיסות + ברכה) | 🟡 זמני — חתוך מההדמיה (07/09) |
| `kai-editions/packages/box-72` | שוט מוצר לחבילת "הזכרונות שלנו" (קופסה + אלבום פתוח + פאוץ' + ברכה) | 🟡 זמני — חתוך מההדמיה (07/09) |
מקור: `ChatGPT Image Sep 7, 2026, 05_25_45 PM.png`. נשמר ב-Git תחת `assets/mockups/packages/`
(+ `_section-mockup.png`). הקרופים קטנים (~390px) — כדאי גרסאות נקיות ברזולוציה גבוהה בהמשך.
